...
class Battle(BaseCog):
    ...
    @commands.command()
    @checks.is_owner()
    async def reloaduser(self, ctx, user: discord.Member = None):
        """
        - Reloads user stats
        """
        with db_session:
    ...
    @commands.command()
    @checks.is_owner()
    async def healuser(self, ctx, user: discord.Member = None):
        """
        - Heals target user
        """
    ...
    @commands.command()
    @checks.is_owner()
    async def fullheal(self, ctx, user: discord.Member = None):
        """
    ...
    async def setstat(
        ...
        """
        - Sets targets chosen attribute to
            * hp
            * points
            * strength
            * wisdom
    ...
    async def attack(self, ctx, user: discord.Member = None):
        ...
        with db_session:
            ...
            if user is None:
                ...
                await ctx.send(
                    f"{ctx.message.author.mention} hurt their self in the confusion!"
